...
export const Home = () => {
    ...
    return (
        ...
        <div className="home section" id="home">
            ...
            <a href="#projects-header"><img onLoad={() => setLoading(false)} src="https://i.ibb.co/wwDVPxk/Nico.jpg" alt="" className="home-img"/ ></a>
            </div>
            {language ? 
            <>
        ...
        <div className="home section" id="home">
            <div className="hero-img-B">
                <a href="#projects-header"><img src="https://i.ibb.co/wwDVPxk/Nico.jpg" alt="" className="home-img"/></a>
            </div>
